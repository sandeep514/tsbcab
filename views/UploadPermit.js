		...
		<ScrollView vertical={true}>
			<View style={{ flex: 1, width: '100%',height: (deviceHeight) }}>
				<View style={{width : '100%',justifyContent: 'center'}}>
					<TouchableHighlight  onPress={() => { handleChoosePhoto('permit') }} style={{borderRadius : 13 , borderWidth: 2 , borderColor: 'lightgrey', backgroundColor: '#e8e8e8',height: 200 ,marginTop: 20,minHeight: 200, width: '90%',justifyContent: 'center', alignItems: 'center'}} >
						{(permit != null)?
							<View>
